...
def parse_args():
    parser = argparse.ArgumentParser(description='Database generation tool for path datasets.')
    ...
    parser.add_argument('-o', '--output_fn',  
                        help='Output file in which to store the generated datbase. (.txt extension)',
                        required=True)
